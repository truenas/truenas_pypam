...
"get_context(*, service_name='login', user, conversation_function=None,\n"
...
"conversation_function : callable, optional\n"
...
"    of responses. See pam_conv(3). When None (default), the context\n"
"    runs PAM authentication on an internal pthread and surfaces\n"
"    conversation prompts via begin_authentication() /\n"
"    continue_authentication() instead of a callback.\n"
